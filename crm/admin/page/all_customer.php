                        ...
                        <div class="box box-primary main-box" style="margin: 0px !important; border-radius: 0;">
                            <form style="margin-bottom: 5px;">
                                <div class="mailbox-controls">
                                    <button type="button" style="width: 124px;" class="btn btn-default refrch_orders make_event" type_event="click" where_click="all_orders" type_text="النقر على زر تحديث الجدول">
                            ...
                            <div class="direct-chat-messages" style="height: 100%; padding: 0; width: 100%;">
                                <table class="table table-bordered table-striped all_orders">
                                    ...
                                    <tr>
                                        ...
                                        <th class="no-sort" style="vertical-align: middle;">حاسسسسسلة الطلب</th>
...
<?php if (isset($_GET['order_id'])) {
    ...
    if (isset($_GET['message_id']))
        $con->query('UPDATE department SET can_show="0" WHERE id =' . $_GET['message_id']);

    else {
        $con->query('UPDATE department SET can_show="0" WHERE order_id =' . $_GET['order_id'] . ' And emp_id=' . $_SESSION['user_id']);
    }
    ...
    <script>
        $(document).ready(function () {
            ...
            setTimeout(function () {
                ...
                setTimeout(function () {
                    setTimeout(function () {
                        $('.open_message_notifcation').click();
                    }, 1000);
                }, 1000);
            }, 1000);
        });
