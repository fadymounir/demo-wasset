...
include '../../config.php'; 
$_SESSION['PAGE'] = isset($_SESSION['PAGE']) ? 10 : 10;
$_SESSION['KIND_PAGE'] = isset($_SESSION['KIND_PAGE']) ? 10 : 10;
            ...
            <div class="box box-primary main-box" style="margin: 0px !important; border-radius: 0;">
              <form style="margin-bottom: 5px;">
                <div class="mailbox-controls">
                  <button type="button" style="width: 124px;" class="btn btn-default refrch_orders make_event"  type_event="click" where_click="all_orders" type_text="النقر على زر التحديث"><i class="fa fa-refresh"></i> تحديث </button>
                  <button type="button" style="width: 124px;" class="btn btn-warning show_filter_main make_event"  type_event="click" where_click="all_orders" type_text="النقر على زر الفلترة"><i class="fa fa-filter" aria-hidden="true"></i> فلترة </button>
                </div>
              </form>
              <div class="header_table_1">
                <p class="number_orders">0 إجمالي عدد العملاء</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="box-body no-padding">
              <form>
                <ul class="nav nav-pills nav-stacked" style="padding-right: 0px;padding-left: 0px;">
                  <li><a id="0" onclick="return GetProblems(this.id);" href="#"><i class="fa fa-inbox"></i> الكل
                      <span class="label label-primary pull-left"><?php echo $num_proplems; ?></span></a>
                  </li>
                  <li><a id="1" onclick="return GetProblems(this.id);" href="#"><i class="fa fa-envelope-o"></i> الجديد</a></li>
                  <li><a id="2" onclick="return GetProblems(this.id);" href="#"><i class="fa fa-clock-o"></i>قيد المعالجة</a></li>
                  <li><a id="3" onclick="return GetProblems(this.id);" href="#"><i class="fa fa-lock"></i>تم الإقفال</a></li>
          ...
          <div class="box box-primary">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
              ...
              <div class="box-footer clearfix no-border">
                <button type="submit" onclick="return AddDepartment();" name="add_department" class="btn btn-default pull-right"> إضافة قسم <i class="fa fa-plus"></i></button>
              </div>
...
<!-- Your Custom Script -->
<script src="<?= DIR_ASSETS ?>js/upload_order.js"></script>
