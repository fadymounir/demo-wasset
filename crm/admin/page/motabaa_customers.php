<?php
    ...
    include '../../config.php'; 
    $_SESSION['PAGE'] = isset($_SESSION['PAGE']) ? 6 : 6;
    $_SESSION['KIND_PAGE'] = isset($_SESSION['KIND_PAGE']) ? 6 : 6;
            ...
            <div class="box box-primary main-box" style="margin: 0px !important; border-radius: 0;">
              <form style="margin-bottom: 5px;">
                <div class="mailbox-controls">
                  <button type="button" style="width: 124px;" class="btn btn-default refrch_orders"><i class="fa fa-refresh"></i> تحديث </button>
                  <button type="button" style="width: 124px;" class="btn btn-warning show_filter_main"><i class="fa fa-filter" aria-hidden="true"></i> فلترة </button>
                </div>
              </form>
